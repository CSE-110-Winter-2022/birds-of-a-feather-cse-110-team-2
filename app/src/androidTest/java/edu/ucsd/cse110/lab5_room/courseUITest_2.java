...
public class courseUITest_2 {
    ...
    public void courseUITest_2() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editText_course_number), withText("123"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.editText_course_number), withText("1234"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
